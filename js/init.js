...
function aali_tm_service_popup() {
  ...
  var button = jQuery(
    ".aali_tm_service .service_list ul li .aali_tm_full_link"
  );
...
function aali_tm_news_popup() {
  ...
  var modalBox = jQuery(".aali_tm_modalbox");
  var button = jQuery(
    ".aali_tm_news .list_inner .aali_tm_full_link,.aali_tm_news .news_list ul li .details .title a,.aali_tm_news .aali_tm_learn_more a"
  );
  var closePopup = modalBox.find(".close");
  ...
  if (myCursor.length) {
    if ($("body")) {
      ...
      (window.onmousemove = function (s) {
        ...
        $("body").on(
          "mouseenter",
          "a,.aali_tm_topbar .trigger, .cursor-pointer",
          function () {
